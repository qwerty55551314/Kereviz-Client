...
import kereviz.module.modules.RiseClickGUIModule;
...
public class RiseClickGUI extends GuiScreen {
    ...
    static {
        ...
        map(Tab.MOVEMENT, "AntiAFK", "Fly", "FastBow", "Speed", "LongJump", "Sprint", "SafeWalk",
                "Jesus", "NoFall", "NoSlow", "KeepSprint", "Eagle", "NoJumpDelay", "MLG", "WaterMLG");
    ...
    public static Color accent() {
        if (Kereviz.moduleManager == null) return new Color(0x14FF00);
        RiseClickGUIModule module = (RiseClickGUIModule) Kereviz.moduleManager.getModule("RiseClickGUI");
        return module != null ? module.getAccentColor() : new Color(0x14FF00);
    }
    ...
    private void rebuildModuleCache() {
        ...
        List<Module> modules = new ArrayList<Module>(Kereviz.moduleManager.modules.values());
    ...
    public void onGuiClosed() {
        ...
        dragging = false;
        Module gui = Kereviz.moduleManager.getModule("RiseClickGUI");
    ...
    private void drawSidebar(int mouseX, int mouseY, float deltaTime) {
        ...
        if (FontManager.productSans24 != null) {
            FontManager.productSans24.drawString("Kereviz", windowX + 14, windowY + 12,
        ...
        if (FontManager.productSans12 != null) {
            float nameWidth = FontManager.productSans24 != null
                    ? (float) FontManager.productSans24.getStringWidth("Kereviz") : 38f;
    ...
    protected void keyTyped(char typedChar, int keyCode) throws IOException {
        ...
        Module clickGUIModule = Kereviz.moduleManager.getModule("RiseClickGUI");
    ...
    private void handleInvWalk() {
        try {
            Module invWalk = Kereviz.moduleManager.getModule("InvWalk");
