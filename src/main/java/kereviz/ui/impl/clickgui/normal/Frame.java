...
import kereviz.ui.impl.clickgui.normal.component.Component;
import kereviz.ui.impl.clickgui.normal.component.ModuleEntry;
import kereviz.util.RenderUtil;
import kereviz.util.font.FontManager;
import kereviz.util.shader.ShadowShader;
...
public class Frame extends Component {
    ...
    public void render(int mouseX, int mouseY, float partialTicks, float animationProgress, boolean isLast, int scrollOffset, float deltaTime) {
        ...
        ClickGUIModule clickGUIModule = (ClickGUIModule) kereviz.Kereviz.moduleManager.getModule("ClickGUI");
