...
public class PlayerStateManager {
    ...
    public void onTick(TickEvent event) {
        kereviz.Kereviz.notificationManager.add("PlayerStateManager: Tick", 0xADD8E6); // Light blue for general tick
        if (event.getType() == kereviz.event.types.EventType.POST) { // Check POST tick to ensure all packet handling for the tick is done
