...
public class RiseModuleCard {
    ...
    private void initValueEditors() {
        if (Kereviz.propertyManager == null || Kereviz.propertyManager.properties == null) return;
    ...
    public void draw(int mouseX, int mouseY, float partialTicks, float deltaTime,
        ...
        RiseClickGUIModule clickGUI = (RiseClickGUIModule) Kereviz.moduleManager.getModule("RiseClickGUI");
        Color accent = clickGUI != null ? clickGUI.getAccentColor() : new Color(0x14FF00);
