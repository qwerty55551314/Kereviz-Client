...
import kereviz.util.shader.ShaderUtil;
import kereviz.util.shader.impl.MainMenu;
...
public final class BackgroundRenderer {
    ...
    public static final int BACKGROUND_KEREVIZ_PLUS = 1;
    ...
    public static String getBackgroundName(int index) {
        switch (index) {
            case BACKGROUND_CLASSIC:
                return "Classic";
            case BACKGROUND_KEREVIZ_PLUS:
                return "Kereviz Client";
