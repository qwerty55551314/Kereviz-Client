...
import kereviz.ui.ClickGui;
import kereviz.ui.Component;
import kereviz.ui.callback.GuiInput;
import kereviz.ui.dataset.Slider;
...
public class SliderComponent implements Component {
    ...
    public void draw(AtomicInteger offset) {
        ...
        Gui.drawRect(sliderStart, this.parentModule.category.getY() + this.offsetY + 11, sliderEnd, this.parentModule.category.getY() + this.offsetY + 15, ((HUD) Kereviz.moduleManager.modules.get(HUD.class)).getColor(System.currentTimeMillis(), offset.get()).getRGB());
        GL11.glPushMatrix();
