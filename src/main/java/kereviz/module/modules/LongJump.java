...
public class LongJump extends Module {
    ...
    public void onEnabled() {
        ...
        if (this.isAutoMode() && this.findFireballInHotbar() == -1) {
            this.setEnabled(false);
            ChatUtil.sendFormatted(String.format("%s%s: &cNo fireball found in your hotbar!&r", Kereviz.clientName, this.getName()));
        } else {
            if (autolag.getValue()) Kereviz.moduleManager.modules.get(ServerLag.class).setEnabled(true);
        }
    }
