...
import kereviz.module.modules.GuiModule;
import kereviz.module.modules.HUD;
import kereviz.ui.Component;
import kereviz.ui.dataset.BindStage;
...
public class BindComponent implements Component {
    ...
    public void draw(AtomicInteger offset) {
        ...
        this.renderText(displayText, ((HUD) Kereviz.moduleManager.modules.get(HUD.class)).getColor(System.currentTimeMillis(), offset.get()).getRGB());
        GL11.glPopMatrix();
    }
