                ...
                case PRE:
                    ...
                    if ((!bedNuker.isEnabled() || !bedNuker.isReady())
                        ...
                        if (players.isEmpty()) {
                            ...
                            Vec3 eyePosition = Kereviz.lagManager.getLastPosition().addVector(0.0, height, 0.0);
                            ...
                            for (EntityPlayer player : players) {
                                ...
                                if (!(distance > (double) this.range.getValue())) {
                                    ...
                                    if (distance < targetDist || distance < eyeDist) {
                                        ...
                                        Kereviz.lagManager.setDelay(this.tickIndex);
                                        this.hasTarget = true;
                                        return;
                                    }
                                }
                    ...
                    break;
                case POST:
                    Vec3 savedPosition = Kereviz.lagManager.getLastPosition();
            ...
            if (this.showPosition.getValue() != 0
                ...
                switch (this.showPosition.getValue()) {
                    case 1:
                        ...
                        break;
                    case 2:
                        color = ((HUD) Kereviz.moduleManager.modules.get(HUD.class)).getColor(System.currentTimeMillis());
                }
