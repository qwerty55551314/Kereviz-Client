...
import kereviz.ui.Component;
import kereviz.ui.dataset.impl.FloatSlider;
import kereviz.ui.dataset.impl.IntSlider;
import kereviz.ui.dataset.impl.PercentageSlider;
...
public class ModuleComponent implements Component {
    ...
    public ModuleComponent(Module mod, CategoryComponent category, int offsetY) {
        ...
        int y = offsetY + 12;
        if (!Kereviz.propertyManager.properties.get(mod.getClass()).isEmpty()) {
            for (Property<?> baseProperty : Kereviz.propertyManager.properties.get(mod.getClass())) {
    ...
    public void draw(AtomicInteger offset) {
        ...
        if (this.mod.isEnabled()) {
            textColor = ((HUD) Kereviz.moduleManager.modules.get(HUD.class)).getColor(System.currentTimeMillis(), offset.get()).getRGB();
        } else {
