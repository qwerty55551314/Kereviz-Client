...
public class ModuleEntry extends Component {
    ...
    private void initializePropertiesComponents() {
        ...
        if (Kereviz.propertyManager != null) {
    ...
    public void render(int mouseX, int mouseY, float partialTicks, float animationProgress, boolean isLast, int scrollOffset, float deltaTime) {
        ...
        kereviz.module.modules.ClickGUIModule clickGUI = (kereviz.module.modules.ClickGUIModule) Kereviz.moduleManager.getModule("ClickGUI");
