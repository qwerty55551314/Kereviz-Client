...
public class AimAssist extends Module {
    ...
    private boolean isInReach(EntityPlayer entityPlayer) {
        Reach reach = (Reach) Kereviz.moduleManager.modules.get(Reach.class);
    ...
    public void onPress(KeyEvent event) {
        if (event.getKey() == mc.gameSettings.keyBindAttack.getKeyCode() && !Kereviz.moduleManager.modules.get(AutoClicker.class).isEnabled()) {
            this.timer.reset();
        }
    }
}
