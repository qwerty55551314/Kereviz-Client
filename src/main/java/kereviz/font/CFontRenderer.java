...
public class CFontRenderer extends CFont {
    ...
    public static Font getFontFromTTF(String fontFileName, float fontSize, int fontType) {
        ...
        ResourceLocation[] locations = new ResourceLocation[]{
                new ResourceLocation("kereviz", "font/" + fontFileName),
                new ResourceLocation("kereviz", "font/" + lowerCaseFileName),
        ...
        String[] classpathPaths = new String[]{
                "/assets/kereviz/font/" + fontFileName,
                "/assets/kereviz/font/" + lowerCaseFileName,
        ...
        System.err.println("[Kereviz] Failed to load CFontRenderer font: " + fontFileName);
    ...
    private static void addDevFontFiles(Set<File> files, File start, String fontFileName, String lowerCaseFileName) {
        ...
        for (int i = 0; current != null && i < 8; i++) {
            files.add(new File(current, "src/main/resources/assets/kereviz/font/" + fontFileName));
            files.add(new File(current, "src/main/resources/assets/kereviz/font/" + lowerCaseFileName));
            files.add(new File(current, "assets/kereviz/font/" + fontFileName));
            files.add(new File(current, "assets/kereviz/font/" + lowerCaseFileName));
            current = current.getParentFile();
        }
    }
