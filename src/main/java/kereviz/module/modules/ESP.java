...
import kereviz.events.ResizeEvent;
import kereviz.mixin.IAccessorEntityRenderer;
...
import kereviz.util.shader.GlowShader;
import kereviz.util.shader.OutlineShader;
    ...
    private Color getEntityColor(EntityPlayer entityPlayer) {
        if (TeamUtil.isFriend(entityPlayer)) {
            ...
            switch (this.color.getValue()) {
                ...
                case 2:
                    int hudColor = ((HUD) Kereviz.moduleManager.modules.get(HUD.class)).getColor(System.currentTimeMillis()).getRGB();
