...
import kereviz.mixin.IAccessorC0DPacketCloseWindow;
...
public class InvWalk extends Module {
    ...
    public void pressMovementKeys(boolean skipSneak) {
        ...
        if (Kereviz.moduleManager.modules.get(Sprint.class).isEnabled()) {
    ...
    public void onUpdate(UpdateEvent event) {
        ...
        if (mc.currentScreen instanceof kereviz.ui.ClickGui && this.guiEnabled.getValue()) {
