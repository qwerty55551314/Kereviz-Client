...
public class Displace extends Module {
    ...
    private void releaseBlink() {
        Kereviz.blinkManager.setBlinkState(false, BlinkModules.DISPLACE);
    }
    ...
    public void onSendPacket(PacketEvent event) {
        ...
        if (Kereviz.blinkManager.getBlinkingModule() == BlinkModules.DISPLACE) {
            return;
        }

        Kereviz.blinkManager.setBlinkState(true, BlinkModules.DISPLACE);
