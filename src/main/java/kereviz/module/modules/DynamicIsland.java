...
import kereviz.util.GlowUtils;
import kereviz.util.RenderUtil;
import kereviz.util.RoundedUtils;
...
public class DynamicIsland extends Module { // nah bro i took 2 hour just to did this shit
    ...
    public final ColorProperty textColor = new ColorProperty("AccentColor", new Color(0x14FF00).getRGB());
    ...
    public void onRender2D(Render2DEvent event) {
        Scaffold scaffold = (Scaffold) kereviz.Kereviz.moduleManager.getModule(Scaffold.class);
        ...
        String text = "Kereviz Client - " + username + " - " + ping + "ms to " + server + " - " + fps + "fps";
        ...
        float part1Width = mc.fontRendererObj.getStringWidth("Kereviz Client");
        mc.fontRendererObj.drawStringWithShadow(
                part1,
        ...
        float part2Width = mc.fontRendererObj.getStringWidth("Kereviz Client" + part1);
        mc.fontRendererObj.drawStringWithShadow(
                part2,
        ...
        float restWidth = mc.fontRendererObj.getStringWidth("Kereviz Client" + part1 + part2);
        mc.fontRendererObj.drawStringWithShadow(
                rest,
