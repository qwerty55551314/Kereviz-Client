        ...
        if (session != null) {
            ...
            if (!StringUtils.isNullOrEmpty(username)) {
                try {
                    ...
                    ChatUtil.sendFormatted(String.format("%sYour username has been copied to the clipboard (&o%s&r)&r", Kereviz.clientName, username));
                } catch (Exception e) {
                    ChatUtil.sendFormatted(String.format("%sFailed to copy&r", Kereviz.clientName));
                }
            }
        }
    }
